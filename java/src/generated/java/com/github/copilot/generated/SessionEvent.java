...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = SessionResponseLimitsChangedEvent.class, name = "session.response_limits_changed"),
    ...
    @JsonSubTypes.Type(value = SessionBinaryAssetEvent.class, name = "session.binary_asset"),
    ...
    @JsonSubTypes.Type(value = McpHeadersRefreshRequiredEvent.class, name = "mcp.headers_refresh_required"),
    @JsonSubTypes.Type(value = McpHeadersRefreshCompletedEvent.class, name = "mcp.headers_refresh_completed"),
