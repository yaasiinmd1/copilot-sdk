...
func matchesToolExecutionCompleteContentResourceDetailsEmbeddedBlobResourceContents(data []byte) bool {
	var rawGroup0 struct {
...
func matchesToolExecutionCompleteContentResourceDetailsEmbeddedTextResourceContents(data []byte) bool {
	var rawGroup0 struct {
		Blob json.RawMessage `json:"blob"`
		Text json.RawMessage `json:"text"`
	}
...
func (r ToolExecutionCompleteContentResourceDetails) MarshalJSON() ([]byte, error) {
	if r.EmbeddedBlobResourceContents != nil {
		return json.Marshal(r.EmbeddedBlobResourceContents)
	}
	if r.EmbeddedTextResourceContents != nil {
		return json.Marshal(r.EmbeddedTextResourceContents)
	}
	return []byte("null"), nil
}
...
func (r *ToolExecutionCompleteContentResourceDetails) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		*r = ToolExecutionCompleteContentResourceDetails{}
		return nil
	}
	if matchesToolExecutionCompleteContentResourceDetailsEmbeddedBlobResourceContents(data) {
		var value EmbeddedBlobResourceContents
		if err := json.Unmarshal(data, &value); err != nil {
			return err
		}
		*r = ToolExecutionCompleteContentResourceDetails{EmbeddedBlobResourceContents: &value}
		return nil
	}
	if matchesToolExecutionCompleteContentResourceDetailsEmbeddedTextResourceContents(data) {
		var value EmbeddedTextResourceContents
		if err := json.Unmarshal(data, &value); err != nil {
			return err
		}
		*r = ToolExecutionCompleteContentResourceDetails{EmbeddedTextResourceContents: &value}
		return nil
	}
	return errors.New("data did not match any union variant for ToolExecutionCompleteContentResourceDetails")
}
